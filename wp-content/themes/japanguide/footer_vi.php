...
<footer id="footer" class="block">
  <div class="container">
    <div class="row mb-3 mb-md-5 justify-content-center">
      <div>
        <img title="<?php bloginfo('name'); ?> "class="main-logo" alt="<?php bloginfo('name'); ?>" src="<?php echo wpedu_get_option('option_logo_footer')['url']; ?>">
      </div>
    </div>
    <div class="row">
      <div class="col-lg-4 col-sm-12">
        ...
        <ul>
          ...
          <li><i class="fa fa-phone mr-2"></i><a href="tel:+842838277722">(+84)28 3827 7722</a> Thứ 2 – Thứ 6 | 8:30 – 18:30</li>
      ...
      <div class="col-lg-3 col-sm-4 mt-4 mt-lg-0">
        <ul>
          ...
          <li><a href="http://www.kilala.vn/awards" target="_blank">www.kilala.vn/awards</a></li>
        </ul>
      </div>
