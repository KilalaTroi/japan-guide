...
<head>
  ...
  <style type="text/css" media="screen"> .frame000{width: 510px; height: 320px;}#js_progressLoading{background: #fff; width: 100vw; height: 100vh; top: 0; left: 0; z-index: 99; position: fixed; z-index: 999999;}#js_progressLoading svg{position: absolute; top: 50%; left: 50%; margin-top: -160px; margin-left: -255px;}</style>
